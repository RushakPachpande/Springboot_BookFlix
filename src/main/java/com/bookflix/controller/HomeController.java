...
public class HomeController {
	...
	public String index(Model m) {
		...
		m.addAttribute("title", "BookFlix - Home Page");
	...
	// @GetMapping("/products")
	// public String products(Model m, @RequestParam(value = "category",
	...
	// }
	// else {
	// page = productService.searchActiveProductPagination(pageNo, pageSize,
	// category, ch);
	// }
	//
	...
	public String product(@PathVariable int id, Model m) {
		...
		m.addAttribute("title", "View Book");
		return "view_product";
	}
	 ...
	 * public String saveUser1(@ModelAttribute UserDtls user, @RequestParam("img")
